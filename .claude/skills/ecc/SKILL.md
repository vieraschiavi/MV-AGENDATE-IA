...
name: ecc
description: >
  Layer ECC (github.com/affaan-m/ECC v2.2.0) instalado en MV Agendate IA: reglas de estilo, testing,
...
1. Correr el gate real del repo y **pegar la salida cruda**, no un resumen:
   ```bash
   npm run lint && npm test   # mismo orden que CI
   ```
   CI corre el lint **antes** que los tests: si el lint falla, los tests ni se ejecutan.
