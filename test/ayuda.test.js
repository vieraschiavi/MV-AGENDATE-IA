...
test('la base de conocimiento cubre los temas centrales del producto', () => {
  ...
  for (const esperado of ['primeros pasos', 'cotizador', 'agenda', 'whatsapp', 'chatvoice', 'retraso', 'dashboards', 'clientes', 'profesionales', 'planes', 'android', 'vercel', 'seguridad']) {
...
test('sin API key responde desde la guía local según palabras clave', async () => {
  ...
  assert.match(r, /Meta for Developers/);
